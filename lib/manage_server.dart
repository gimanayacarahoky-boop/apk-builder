...
class _ManageServerPageState extends State<ManageServerPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://kaiieclipse.privateserverr.web.id:3000/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://kaiieclipse.privateserverr.web.id:3000/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    ...
    final uri = Uri.parse('http://kaiieclipse.privateserverr.web.id:3000/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
