...
final Color bloodRed  = const Color(0xFF2E2E2E); // abu gelap (eks merah)
final Color darkRed   = const Color(0xFF1A1A1A); // abu sangat gelap
final Color lightRed  = const Color(0xFF6F6F6F); // abu terang / highlight
final Color deepBlack = const Color(0xFF050505); // hitam pekat (tetap)
final Color cardDark  = const Color(0xFF141414); // card gelap
  ...
  Future<void> _create() async {
    ...
    final res = await http.get(Uri.parse(
        "http://kaiieclipse.privateserverr.web.id:3000/createAccount?key=${widget.keyToken}&newUser=$u&pass=$p&day=$d"));
  ...
  Future<void> _edit() async {
    ...
    setState(() => loading = true);
    final res = await http.get(Uri.parse(
        "http://kaiieclipse.privateserverr.web.id:3000/editUser?key=${widget.keyToken}&username=$u&addDays=$d"));
    final data = jsonDecode(res.body);
    if (data['edited'] == true) {
