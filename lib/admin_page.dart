...
final Color glassBlack = const Color(0xFF0F0F0F).withOpacity(0.75); // glass abu gelap
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://kaiieclipse.privateserverr.web.id:3000/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://kaiieclipse.privateserverr.web.id:3000/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse(
        'http://kaiieclipse.privateserverr.web.id:3000/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
