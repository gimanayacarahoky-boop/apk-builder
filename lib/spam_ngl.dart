...
// Warna tema hitam – abu (nama const TETAP)
final Color primaryDark   = const Color(0xFF050505); // hitam pekat (eks biru gelap)
final Color primaryBlue   = const Color(0xFF1A1A1A); // abu sangat gelap
final Color accentBlue    = const Color(0xFF2E2E2E); // abu gelap (aksen / border)
final Color lightBlue     = const Color(0xFF6F6F6F); // abu terang (highlight / icon)
final Color primaryWhite  = const Color(0xFFFFFFFF); // putih (tetap)
final Color accentGrey    = const Color(0xFFBDBDBD); // abu netral (pengganti grey.shade400)
final Color cardDark      = const Color(0xFF121212); // card gelap
final Color glassColor    = const Color(0x1FFFFFFF); // kaca transparan (tetap)
